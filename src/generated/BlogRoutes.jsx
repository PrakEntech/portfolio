...
import Blog_ai_powered_root_cause_analysis from '../pages/blogs/Blog_ai_powered_root_cause_analysis.jsx';
...
export default function BlogRoutes() {
  return (
    <Routes>
      ...
      <Route path="ai_powered_root_cause_analysis" element={<Blog_ai_powered_root_cause_analysis />} />
    </Routes>
  );
}
